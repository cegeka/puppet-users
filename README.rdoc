...
This is the users module. Use this module to create users and/or groups, create a
bin directory in the homedir and to distribute the public key you normally use to
authenticate to a remote machine.
